const Hero = () => {
	return (
		<section className='max-w-[1920px] lg:bg-hero lg:min-h-[1170px] relative lg:bg-cover bg-top bg-heroMob bg-cover bg-no-repeat min-h-[390px] mb-[470px] sm:mb-80 md:mb-64 lg:mb-[600px] xl:mb-[470px] mx-auto'>
			...
			<div className='text-white bg-yellow lg:px-14 lg:py-10 max-w-[830px] lg:rounded-3xl flex gap-10 flex-col items-center absolute lg:right-[10%] lg:top-[68%] px-4 py-5 rounded-l-2xl right-0 ml-[10%] -bottom-5 lg:bottom-auto'>
				...
				<p className='hidden text-2xl lg:block'>
					...
					свої обов&apos;язки та захищати права тварин. Проявляючи
					громадянську активність, ми можемо вплинути на позитивні
					зміни в нашому суспільстві і сприяти вирішенню соціальних
					проблем.
				</p>
			</div>
			...
			<div className='lg:text-2xl bg-pink p-7 max-w-[905px] rounded-3xl absolute top-[111%] lg:left-[18%] z-10 text-sm mx-[10%]'>
				<p>
					...
					слів. Тварини стають нашими найкращими друзями і надійними
					співрозмовниками, якими можна довіритися у будь-якому
					життєвому шляху. При захисті тварин ми прагнемо досягти
					балансу між людиною і природою. Це вимагає нашої уваги,
					зусиль та відповідальності. Збереження довкілля і по вага до
					тварин є важливими кроками для створення гармонійного світу.
					Ми маємо розуміти, що вони теж мають право на щасливе та
					безпечне існування.
				</p>
			</div>
		</section>
