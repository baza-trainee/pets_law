  ...
  return (
    <article className="md:!flex md:!justify-center px-3">
      <div className="px-5 bg-yellowBg md:bg-white py-7 rounded-3xl w-[330px] xl:w-[417px] h-[682px] md:h-[554px]">
        ...
        <p className="overflow-y-scroll h-[380px] md:h-[230px] xl:h-[200px] text-lg xl:scrollbar-w-3 xl:scrollbar xl:scrollbar-thumb-gray-700 xl:scrollbar-track-gray-300 xl:scrollbar-thumb-rounded-full xl:scrollbar-track-rounded-full">
